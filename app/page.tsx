      ...
      <div className="bg-white shadow-lg p-5 w-full rounded-3xl max-w-screen-sm dark:bg-gray-600">
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            <span className="text-gray-500 font-semibold -mb-1 dark:text-gray-300">
              In transit
            </span>
        ...
        <div className="my-2 flex items-center gap-2">
          <span className="bg-green-400 text-white uppercase px-2.5 py-1.5 text-sm font-medium rounded-full transition hover:bg-green-600 hover:scale-125">
            Today
          </span>
